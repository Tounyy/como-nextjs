...
const Contact: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col sm:flex-row-reverse items-center text-left w-full">
      <div className="flex flex-wrap max-w-[1500px] 4k:max-w-[3000px] mx-auto font-thin w-full px-6">
        <div className="w-full bg-white mx-auto">
          
        <div className="flex flex-col items-center justify-center">
          <h2 className="text-4xl w-2/3 text-center font-bold text-gray-800 mb-12">
