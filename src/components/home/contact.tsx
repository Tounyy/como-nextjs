...
const Contact: React.FC<ContactProps> = () => {
  ...
  return (
    <section className="min-h flex items-center justify-center p-4">
      <div className="container grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white p-2 shadow-md rounded-lg border border-gray-300 sm:p-8 min-h-[30vh] max-w-[1200px] mx-auto 4xl:max-w-[1500px] 4xl:min-h-[50vh] 3xl:max-w-[1500px] 3xl:min-h-[30vh]">
        {/* Left */}
