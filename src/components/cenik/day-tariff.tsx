...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { feature: '1 hod. Zasedací místnost' },
    ],
    excludedFeatures: [
...

  {
    ...
    features: [
      ...
      { feature: 'Kávovar' },
      { feature: 'Skvělé zázemí' },
      { feature: '4 hod. Zasedací místnost' },
    ],
    excludedFeatures: [
      { feature: 'Uzamykatelná skříň' },
      { feature: '10 míst k sezení' },
    ...
    <div className="flex flex-wrap justify-center items-center max-w-[1500px] 4k:max-w-[3000px] mx-auto font-semibold px-6">
      ...
      <div className="w-full flex relative grid lg:grid-cols-1 sm:grid-cols-1">
        ...
        <div className="w-full flex justify-center relative">
          <h2 className="text-gray-800 text-4xl font-bold py-6">Denní tarify</h2>
        </div>

        <ul className='px-20 mt-6'>
            <p className='font-thin'><span className='font-bold'> - </span>
              Hodinové tarify se uzavírají na dobu 1 roku.
            </p>
            <p className='font-thin'><span className='font-bold'> - </span>
              Fond předplacených návštěv musí být vyčerpán do 1 roku od uzavření smluvního vztahu.
            </p>
            <p className='font-thin'><span className='font-bold'> - </span>
              V opačném případě fond bez náhrady propadá.
            </p>
            <p className='font-thin'><span className='font-bold'> - </span>
