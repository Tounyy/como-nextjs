    ...
    <section className="relative flex flex-col sm:flex-row-reverse items-center text-left w-full">
      <div className="flex flex-wrap max-w-[1500px] 4k:max-w-[3000px] mx-auto font-thin w-full p-6">
        ...
        <div className="flex flex-col items-left justify-center text-left px-0 md:p-6">
          <h2 className="text-lg font-semibold text-gray-600 mb-2 text-center md:text-left">COMO - NAPSAT NÁM NENÍ VŮBEC TĚŽKÉ</h2>
          <h1 className="text-4xl font-bold text-gray-900 mb-4 text-center mt-6">Napište nám!</h1>
