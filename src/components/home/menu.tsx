...
const plans: Plan[] = [
...

  {
    ...
    time: 'Pro inkubaci vašich nápadů',
    price: '500 Kč',
    details: 'za 1 měsíc',
    features: [
      { feature: '24/7' },
  ...
  return (
    <div className="flex flex-wrap justify-center items-center max-w-[1500px] 4k:max-w-[3000px] mx-auto font-semibold px-6">
      ...
      <div className="text-center">
        <h2 className="text-gray-800 text-4xl font-bold mb-4">Ceník</h2>
      </div>

      <div className="grid lg:grid-cols-4 sm:grid-cols-2 gap-6 mt-12 w-full ">
        {plans.map((plan) => (
          <div key={plan.name} className="border border-black rounded-lg overflow-hidden">
            ...
            <div className='bg-[#008DD2] p-6 py-10'>
              ...
              <p className="text-sm text-white text-center font-thin">{plan.time}</p>
            </div>

            <div className='p-6'>
              <div className="mt-0">
                <h3 className="text-black text-3xl font-semibold text-center">{plan.price}</h3>
                <p className="text-sm text-[#555555] text-center font-extralight">{plan.details}</p>
              </div>
