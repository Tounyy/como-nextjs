    ...
    <section className="relative min-h w-full overflow-hidden font-poppins text-center py-7">
      <div className="flex justify-center flex-wrap">
        <div className="container m-4 p-5 bg-white rounded-lg max-w-sm">
          <h2 className="text-2xl text-[#353C73] font-bold mb-5 text-left 3xl:text-4xl">Stránky</h2>
          <ul className="space-y-2 text-left 3xl:text-2xl">
        ...
        <div className="container m-4 p-5 bg-white rounded-lg max-w-sm">
          <h2 className="text-2xl text-[#353C73] font-bold mb-5 text-left 3xl:text-4xl">Sídlo Kanceláře</h2>
          <address className="not-italic space-y-2 text-left 3xl:text-2xl">
        ...
        <div className="container m-4 p-5 bg-white rounded-lg max-w-sm">
          ...
          <p className="text-left 3xl:text-2xl">Brand Manual s logotypy <span onClick={() => navigateTo('...')} className='hover:text-blue-600 transition-colors cursor-pointer'>ZDE</span>.</p>
        </div>
      </div>
    </section>
  );
